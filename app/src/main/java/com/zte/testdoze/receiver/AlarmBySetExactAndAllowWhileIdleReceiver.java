 ...
 */
public class AlarmBySetExactAndAllowWhileIdleReceiver extends BroadcastReceiver
{
    private static AlarmBySetExactAndAllowWhileIdleReceiver instance = new AlarmBySetExactAndAllowWhileIdleReceiver();
    ...
    private AlarmBySetExactAndAllowWhileIdleReceiver()
    {
    }

    private static AlarmBySetExactAndAllowWhileIdleReceiver getInstance()
    {
        return instance;
    }
    ...
    private synchronized void oper(Context context, int type, long intervalMillis)
    {
        ...
        if (0 == type)
        {
            ...
            localAlarmManager.setExactAndAllowWhileIdle(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + intervalMillis, localPendingIntent);
