 ...
 */
public class AlarmBySetInexactRepeatingReceiver extends BroadcastReceiver
{
    private static AlarmBySetInexactRepeatingReceiver instance = new AlarmBySetInexactRepeatingReceiver();
    ...
    private AlarmBySetInexactRepeatingReceiver()
    {
    }

    private static AlarmBySetInexactRepeatingReceiver getInstance()
    {
        return instance;
    }
    ...
    private synchronized void oper(Context context, int type, long intervalMillis)
    {
        ...
        if (0 == type)
        {
            ...
            localAlarmManager.setInexactRepeating(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + intervalMillis, intervalMillis, localPendingIntent);
        }
        else
        {
            // 关闭
